...
소형 업데이트는 누적형입니다. 예를 들어 0.1.1~0.1.3을 건너뛰고 이후 0.1.4만 설치해도 이전 소형 업데이트의 프로그램 코드 변경이 최신 EXE에 함께 포함됩니다.
...
**Actions → Build Lightweight Windows Update**에서 실행 결과를 열고 `Vegas-Total-Solution-Doc-Update-0.1.4` artifact를 내려받습니다.
