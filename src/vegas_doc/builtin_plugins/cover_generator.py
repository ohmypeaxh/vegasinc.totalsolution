...
class CoverGeneratorWidget(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        logo_help = QLabel(
            "같은 로고를 ##고객사로고1##~##고객사로고5##에 가운데 정렬합니다. "
            "1번 높이 2.11cm · 2번 가로 1.38cm · 3~5번 가로 2.4cm"
        )
        logo_help.setObjectName("MutedText")
        logo_help.setWordWrap(True)
